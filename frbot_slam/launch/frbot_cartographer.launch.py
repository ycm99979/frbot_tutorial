...
def generate_launch_description():
    package_path = get_package_share_directory('frbot_slam')
    
    # 설정 파일 경로
    cartographer_config_dir = os.path.join(package_path, 'config', 'cartographer.lua')
    rviz_config_dir = os.path.join(package_path, 'rviz')
    
    # Cartographer 파라미터
    use_sim_time = LaunchConfiguration('use_sim_time', default='False') #실제 로봇에 적용하기 위해서는 false
